...
translation: {
      ...
      root: {
        ...
        settings: {
          ...
          subtitle: "Ko'rinish, xavfsizlik va yordam sozlamalari.",
        ...
        schoolPage: {
          ...
          inactive: "Nofaol",
          soon: "Tez orada",
          viewingAs: "{{role}} sifatida ko'rilmoqda — faqat o'qish",
          roles: {
            owner: "Egasi",
            director: "Direktor",
            admin: "Administrator",
          ...
          edit: {
            ...
            description: "Maktab profilidagi ommaviy ma'lumotlarni yangilang.",
          ...
          invite: {
            ...
            menuStudents: "O'quvchilar qo'shish",
          },
          inviteTeacher: {
            title: "O'qituvchini taklif qilish",
            description: "Uning emailiga bog'langan bir martalik taklif havolasini yuboring.",
            emailLabel: "O'qituvchi emaili",
            emailPlaceholder: "teacher@school.edu",
            emailError: "O'qituvchining to'g'ri emailini kiriting.",
            hint: "O'qituvchilar javoblarni ko'radi, shuning uchun taklif har doim emailga bog'langan noyob havola — umumiy kod emas.",
            submit: "Taklif yaratish",
            cancel: "Bekor qilish",
            error: "Taklif yaratib bo'lmadi. Qayta urinib ko'ring.",
            created: "{{email}} uchun taklif yaratildi.",
            linkLabel: "Taklif havolasi",
            copyLink: "Havolani nusxalash",
            linkCopied: "Havola nusxalandi",
            linkCopyError: "Havolani nusxalab bo'lmadi",
            done: "Tayyor",
          },
          addStudents: {
            title: "O'quvchilar qo'shish",
            description: "O'quvchilar maktabga qo'shilishi uchun qo'shilish kodini ulashing.",
            noCode: "O'quvchilar uchun qo'shilish kodi hali mavjud emas.",
            hint: "O'quvchilar bu kodni «Sinflar» → «Maktabga qo'shilish» bo'limida kiritadi.",
            done: "Tayyor",
          },
          createClass: {
            title: "Sinf yaratish",
            description: "Maktabingizga sinf qo'shing. O'qituvchi va o'quvchilarni keyin tayinlashingiz mumkin.",
            nameLabel: "Sinf nomi",
        ...
        classes: {
          ...
          subtitleTeacher: "Siz o'qitadigan {{count}} ta sinf",
          subtitleAdmin: "Maktabingizdagi {{count}} ta sinf",
          subtitleEmpty: "Hozircha sinflar yo'q",
          noneTitle: "Siz hali hech qanday sinfda emassiz",
          noneDescription: "Siz qo'shilgan yoki o'qitadigan sinflar shu yerda ko'rinadi.",
          stats: {
            classes: "Sinflar",
            students: "O'quvchilar",
        ...
        enrollment: {
          errorGeneric: "Nimadir xato ketdi. Qayta urinib ko'ring.",
          loading: "Yuklanmoqda…",
          ...
          mode: {
            ...
            directAssignment: "O'qituvchi biriktiradi",
            open: "Erkin qo'shilish",
          },
          overview: {
          ...
          discover: {
            ...
            assignmentRequired: "O'qituvchi biriktirishi kerak",
          ...
          requestDialog: {
            ...
            description: "Sinf o'qituvchisiga yoki administratorga so'rov yuboring.",
            messageLabel: "Xabar (ixtiyoriy)",
            messagePlaceholder: "O'qituvchi uchun qisqa izoh qoldiring…",
            cancel: "Bekor qilish",
            submit: "So'rov yuborish",
          },
          requests: {
            title: "Kutilayotgan so'rovlar",
            subtitle: "Tasdiqlash kutayotgan sinf so'rovlari.",
            cancel: "So'rovni bekor qilish",
            cancelledToast: "So'rov bekor qilindi.",
            errorTitle: "So'rovlarni yuklab bo'lmadi",
            errorDescription: "Birozdan so'ng qayta urinib ko'ring.",
            emptyTitle: "Kutilayotgan so'rovlar yo'q",
            emptyDescription:
              "Yuborgan so'rovlaringiz ko'rib chiqilgunicha shu yerda turadi.",
          },
          classRequests: {
            back: "Sinfga qaytish",
            title: "Qo'shilish so'rovlari",
            subtitle: "{{name}} uchun kutilayotgan so'rovlar.",
            approve: "Tasdiqlash",
            reject: "Rad etish",
            approvedToast: "So'rov tasdiqlandi.",
            rejectedToast: "So'rov rad etildi.",
            errorTitle: "So'rovlarni yuklab bo'lmadi",
            errorDescription: "Birozdan so'ng qayta urinib ko'ring.",
            emptyTitle: "Kutilayotgan so'rovlar yo'q",
            emptyDescription: "Bu sinf uchun yangi so'rovlar shu yerda ko'rinadi.",
            rejectTitle: "{{name}} so'rovini rad etilsinmi?",
            rejectDescription: "Xohlasangiz, o'quvchiga sababni ko'rsating.",
            reasonLabel: "Sabab (ixtiyoriy)",
            reasonPlaceholder: "O'quvchi uchun sabab qo'shing…",
            cancel: "Bekor qilish",
            confirmReject: "So'rovni rad etish",
          },
          assign: {
            title: "O'quvchi qo'shish",
            description: "Maktab o'quvchisini to'g'ridan-to'g'ri bu sinfga biriktiring.",
            searchPlaceholder: "O'quvchilarni qidirish",
            add: "Qo'shish",
            remove: "Olib tashlash",
            noResults: "Mos o'quvchilar yo'q.",
            allAssigned: "Barcha o'quvchilar allaqachon bu sinfda.",
            assignedToast: "{{name}} sinfga qo'shildi.",
